...
public class BlockAStar {
    ...
    // INIT
    @API
    public BlockAStar(Location startLocation, Location endLocation) {
    ...
    public void findPath() {
        ...
        } else // this looks through the provided options and checks if an ability of the pathfinder is deactivated,
    ...
    protected boolean canStandAt(Location feetLocation) {
    ...
    // LOCATION VALIDATION
    @SuppressWarnings("deprecation")
    protected boolean isBlockUnobstructed(Location location) {
